...
//------------PIT中断参数相关定义------------
#define CCU6_0_CH0_INT_SERVICE	IfxSrc_Tos_cpu0	//定义CCU6_0 PIT通道0中断服务类型，即中断是由谁响应处理 IfxSrc_Tos_cpu0 IfxSrc_Tos_cpu1 IfxSrc_Tos_cpu2 IfxSrc_Tos_dma   不可设置为其他值
...
#define ERU_CH0_CH4_INT_SERVICE IfxSrc_Tos_cpu0	//定义ERU通道0和通道4中断服务类型，即中断是由谁响应处理 IfxSrc_Tos_cpu0 IfxSrc_Tos_cpu1 IfxSrc_Tos_cpu2 IfxSrc_Tos_dma   不可设置为其他值
...
//------------DMA中断参数相关定义------------
#define	ERU_DMA_INT_SERVICE     IfxSrc_Tos_cpu0	//ERU触发DMA中断服务类型，即中断是由谁响应处理 IfxSrc_Tos_cpu0 IfxSrc_Tos_cpu1 IfxSrc_Tos_cpu2 IfxSrc_Tos_dma   不可设置为其他值
#define ERU_DMA_INT_PRIO  	    60	//ERU触发DMA中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样


//------------串口中断参数相关定义------------
#define	UART0_INT_SERVICE       IfxSrc_Tos_cpu0	//定义串口0中断服务类型，即中断是由谁响应处理 IfxSrc_Tos_cpu0 IfxSrc_Tos_cpu1 IfxSrc_Tos_cpu2 IfxSrc_Tos_dma   不可设置为其他值
