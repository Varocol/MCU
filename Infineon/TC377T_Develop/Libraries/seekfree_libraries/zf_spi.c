...
void spi_mux(SPIN_enum spi_n, SPI_PIN_enum sck_pin, SPI_PIN_enum mosi_pin, SPI_PIN_enum miso_pin, SPI_PIN_enum cs_pin, IfxQspi_SpiMaster_Pins *set_pin, IfxQspi_SpiMaster_Output *set_cs)
{
	...
	switch(spi_n)
	{
		...
		case SPI_3:
		{
            ...
            else if (SPI3_CS0_P33_10 == cs_pin)     set_cs->pin = &IfxQspi4_SLSO0_P33_10_OUT;
            else if (SPI3_CS1_P02_0  == cs_pin)     set_cs->pin = &IfxQspi3_SLSO1_P02_0_OUT;
            else if (SPI3_CS1_P33_9  == cs_pin)     set_cs->pin = &IfxQspi4_SLSO1_P33_9_OUT;
            else if (SPI3_CS2_P02_1  == cs_pin)     set_cs->pin = &IfxQspi3_SLSO2_P02_1_OUT;
            else if (SPI3_CS2_P33_8  == cs_pin)     set_cs->pin = &IfxQspi4_SLSO2_P33_8_OUT;
            //else if (SPI3_CS2_P33_3  == cs_pin)     set_cs->pin = &IfxQspi4_SLSO2_P33_3_OUT;
            ...
            else if (SPI3_CS3_P22_2  == cs_pin)     set_cs->pin = &IfxQspi4_SLSO3_P22_2_OUT;
            ...
            //else if (SPI3_CS4_P23_5  == cs_pin)     set_cs->pin = &IfxQspi4_SLSO4_P23_5_OUT;
            else if (SPI3_CS5_P02_8  == cs_pin)     set_cs->pin = &IfxQspi3_SLSO5_P02_8_OUT;
            //else if (SPI3_CS5_P23_4  == cs_pin)     set_cs->pin = &IfxQspi4_SLSO5_P23_4_OUT;
            else if (SPI3_CS6_P00_8  == cs_pin)     set_cs->pin = &IfxQspi3_SLSO6_P00_8_OUT;
            else if (SPI3_CS6_P23_1  == cs_pin)     set_cs->pin = &IfxQspi4_SLSO6_P23_1_OUT;
            else if (SPI3_CS7_P00_9  == cs_pin)     set_cs->pin = &IfxQspi3_SLSO7_P00_9_OUT;
            else if (SPI3_CS7_P02_1  == cs_pin)     set_cs->pin = &IfxQspi4_SLSO7_P02_1_OUT;
            else if (SPI3_CS7_P33_7  == cs_pin)     set_cs->pin = &IfxQspi4_SLSO7_P33_7_OUT;
            else if (SPI3_CS8_P10_5  == cs_pin)     set_cs->pin = &IfxQspi3_SLSO8_P10_5_OUT;
            //else if (SPI3_CS9_P01_3  == cs_pin)     set_cs->pin = &IfxQspi3_SLSO9_P01_3_OUT;
            //else if (SPI3_CS10_P01_4 == cs_pin)     set_cs->pin = &IfxQspi3_SLSO10_P01_4_OUT;
			else	ZF_ASSERT(FALSE);
		}break;
	}
}
...
//-------------------------------------------------------------------------------------------------------------------
//  @brief      SPI初始化
//  @param      spi_n           选择SPI模块(SPI_1-SPI_3)
