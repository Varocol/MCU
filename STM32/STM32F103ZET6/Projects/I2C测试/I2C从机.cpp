...
void Test()
{
    PLATFORM_SERIAL.Send_String_DMA("123\n");
    ...
    PLATFORM_SERIAL.Send_String_DMA("456\n");
...
void i2c1_ev_handler()
{
    ...
    case EV1_2: // I2C_EVENT_SLAVE_RECEIVER_ADDRESS_MATCHED
        ...
        PLATFORM_SERIAL.Send_String_DMA("\n[I2C1]:已匹配上地址\n");
        break;
    case EV2_1: // I2C_EVENT_SLAVE_BYTE_RECEIVED
    {
        ...
        PLATFORM_SERIAL.Send_String_DMA("0x");
        PLATFORM_SERIAL.Send_Data_DMA(hex[tmp / 16]);
        PLATFORM_SERIAL.Send_Data_DMA(hex[tmp % 16]);
        PLATFORM_SERIAL.Send_String_DMA(" ");
    }
    break;
