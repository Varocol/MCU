...
DEVICE:=MSP430F67791A
EXAMPLE:=eusci_b_i2c_ex5_masterMultipleSlave
...
INCLUDES         := -I $(GCC_MSP_INC_DIR) -I $(GCC_INC_DIR) -I ../../../../driverlib/MSP430F5xx_6xx -I ../..
######################################
DRIVERLIB_SRC    := $(wildcard ../../../../driverlib/MSP430F5xx_6xx/*.c)
