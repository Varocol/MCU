...
DEVICE:=MSP430i2041
EXAMPLE:=sd24_ex6_singleConversionSingleConversionTempSensor
...
INCLUDES         := -I $(GCC_MSP_INC_DIR) -I $(GCC_INC_DIR) -I ../../../../driverlib/MSP430i2xx -I ../..
######################################
DRIVERLIB_SRC    := $(wildcard ../../../../driverlib/MSP430i2xx/*.c)
